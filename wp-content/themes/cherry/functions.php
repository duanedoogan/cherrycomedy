...
add_image_size( 'event-poster', 443, 627 );
add_image_size( 'comic-300', 300, 300, true );
add_image_size( 'comic-600', 600, 600, true );
add_image_size( 'comic-1200', 1200, 1200, true );
add_image_size( 'img-1400', 1400, 0 );
add_image_size( 'blog-listing-new', 350, 250, true );
add_image_size( 'blog-heading', 825, 505 );
add_image_size( 'in-this-article', 99999, 256 );
add_image_size( 'comic-article', 181, 256, true );
add_image_size( 'footer-gallery', 228, 228 );
add_image_size( 'home-listing', 185, 185 );
