	...
	<script type="text/javascript">
		(function($) {
			...
			jQuery(document).ready(function() {
				...
				<?php if(!empty(get_option('ald_wrapper_class'))):?>
					...
					jQuery(window).load(function(){
						setTimeout(function(){
							...
							$("<?php _e( $ald_load_class ); ?>").hide().slice(0, <?php _e( $ald_item_show ); ?>).show();
						}, 500)
					});
				...
				//wrapper 7
				<?php if(!empty(get_option('ald_wrapper_classf'))):?>

					<?php $ald_wrapper_class = get_option('ald_wrapper_classf'); ?>
					<?php $ald_load_class = get_option('ald_load_classf'); ?>
					<?php $ald_load_label = get_option('ald_load_labelf'); ?>
					<?php $ald_item_show = get_option('ald_item_showf'); ?>
					<?php $ald_item_load = get_option('ald_item_loadf'); ?>
				...
				//wrapper 8
				<?php if(!empty(get_option('ald_wrapper_classg'))):?>

					<?php $ald_wrapper_class = get_option('ald_wrapper_classg'); ?>
					<?php $ald_load_class = get_option('ald_load_classg'); ?>
					<?php $ald_load_label = get_option('ald_load_labelg'); ?>
					<?php $ald_item_show = get_option('ald_item_showg'); ?>
					<?php $ald_item_load = get_option('ald_item_loadg'); ?>
