...
if ( !defined('ALD_PLUGIN_VERSION') ) {
    define('ALD_PLUGIN_VERSION', '2.4.6');
}
	...
	<table class="form-table">
		<tr>
			<td class="left-col">
				...
				<!-- Wrapper Six Start -->
				<div id="postimagediv" class="postbox">
					<a class="header" data-toggle="collapsf" href="#divseven">
						<span id="poststuff">
							<h2 class="hndle"><?php esc_html_e( 'Wrapper - 7 ( For Flex Display )', 'aldtd' ); ?></h2>
						</span>
					</a>
					<div id="divseven" class="collapsf">
						<div class="inside">
							<table class="form-table">
								<tr valign="top">
									<th scope="row"><?php _e( $load_more_button_wrapper ); ?></th>
									<td>
										<input class="regular-text" type="text" name="ald_wrapper_classf" value="<?php echo esc_attr( get_option('ald_wrapper_classf') ); ?>" />
										<p><?php _e( $load_more_button_wrapper_desc ); ?></p>
									</td>
								</tr>
								<tr valign="top">
									<th scope="row"><?php _e( $load_more_item_selector ); ?></th>
									<td>
										<input class="regular-text" type="text" name="ald_load_classf" value="<?php echo esc_attr( get_option('ald_load_classf') ); ?>" />
										<p><?php _e( $load_more_item_selector_desc ); ?></p>
									</td>
								</tr>
								<tr valign="top">
									<th scope="row"><?php _e( $visiable_items ); ?></th>
									<td>
										<input class="regular-text" type="number" name="ald_item_showf" value="<?php echo esc_attr( get_option('ald_item_showf') ); ?>" />
										<p><?php _e( $visiable_items_desc ); ?></p>
									</td>
								</tr>
								<tr valign="top">
									<th scope="row"><?php _e( $load_items ); ?></th>
									<td>
										<input class="regular-text" type="number" name="ald_item_loadf" value="<?php echo esc_attr( get_option('ald_item_loadf') ); ?>" />
										<p><?php _e( $load_items_desc ); ?></p>
									</td>
								</tr>
								<tr valign="top">
									<th scope="row"><?php _e( $button_label ); ?></th>
									<td>
										<input class="regular-text" type="text" name="ald_load_labelf" value="<?php echo esc_attr( get_option('ald_load_labelf') ); ?>" />
										<p><?php _e( $button_label_desc ) ?></p>
									</td>
								</tr>
							</table>
				...
				<!-- Wrapper Seven Start -->
				<div id="postimagediv" class="postbox">
					<a class="header" data-toggle="collapsg" href="#diveight">
						<span id="poststuff">
							<h2 class="hndle"><?php esc_html_e( 'Wrapper - 8 ( For Flex Display )', 'aldtd' ); ?></h2>
						</span>
					</a>
					<div id="diveight" class="collapsg">
						<div class="inside">
							<table class="form-table">
								<tr valign="top">
									<th scope="row"><?php _e( $load_more_button_wrapper ); ?></th>
									<td>
										<input class="regular-text" type="text" name="ald_wrapper_classg" value="<?php echo esc_attr( get_option('ald_wrapper_classg') ); ?>" />
										<p><?php _e( $load_more_button_wrapper_desc ); ?></p>
									</td>
								</tr>
								<tr valign="top">
									<th scope="row"><?php _e( $load_more_item_selector ); ?></th>
									<td>
										<input class="regular-text" type="text" name="ald_load_classg" value="<?php echo esc_attr( get_option('ald_load_classg') ); ?>" />
										<p><?php _e( $load_more_item_selector_desc ); ?></p>
									</td>
								</tr>
								<tr valign="top">
									<th scope="row"><?php _e( $visiable_items ); ?></th>
									<td>
										<input class="regular-text" type="number" name="ald_item_showg" value="<?php echo esc_attr( get_option('ald_item_showg') ); ?>" />
										<p><?php _e( $visiable_items_desc ); ?></p>
									</td>
								</tr>
								<tr valign="top">
									<th scope="row"><?php _e( $load_items ); ?></th>
									<td>
										<input class="regular-text" type="number" name="ald_item_loadg" value="<?php echo esc_attr( get_option('ald_item_loadg') ); ?>" />
										<p><?php _e( $load_items_desc ); ?></p>
									</td>
								</tr>
								<tr valign="top">
									<th scope="row"><?php _e( $button_label ); ?></th>
									<td>
										<input class="regular-text" type="text" name="ald_load_labelg" value="<?php echo esc_attr( get_option('ald_load_labelg') ); ?>" />
										<p><?php _e( $button_label_desc ) ?></p>
									</td>
								</tr>
							</table>
...
function register_ald_plugin_settings() {
	...
	register_setting( 'ald-plugin-settings-group', 'ald_wrapper_classf' );
	register_setting( 'ald-plugin-settings-group', 'ald_load_classf' );
	register_setting( 'ald-plugin-settings-group', 'ald_item_showf' );
	register_setting( 'ald-plugin-settings-group', 'ald_item_loadf' );
	register_setting( 'ald-plugin-settings-group', 'ald_load_labelf' );

	register_setting( 'ald-plugin-settings-group', 'ald_wrapper_classg' );
	register_setting( 'ald-plugin-settings-group', 'ald_load_classg' );
	register_setting( 'ald-plugin-settings-group', 'ald_item_showg' );
	register_setting( 'ald-plugin-settings-group', 'ald_item_loadg' );
	register_setting( 'ald-plugin-settings-group', 'ald_load_labelg' );
}
